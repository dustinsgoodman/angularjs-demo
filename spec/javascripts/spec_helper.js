...
beforeEach(function() {
  ...
  // load SpringbotApp module by default
  module('TodoApp');
  ...
  module(function($provide) {
    ...
    $provide.factory('$scope', function($rootScope) { return $rootScope.$new(); });

  });

  this.addMatchers({
    toBePromise: function() {
      return this.actual && this.actual.then && typeof this.actual.then == 'function';
    },
